...
int nodenum = 0;                              //节点数目
	...
	public Extended_BMLPA(String file, double p)
	{
		this.p = p;
	...
	public static void main(String args[])
	{
		...
		double pvalue[] = {0.3,0.4,0.5,0.55,0.6,0.65,0.7,0.75,0.9,0.85,0.9,0.95};
			...
			for(int j=0;j<pvalue.length;j++)
			{
				...
				Extended_BMLPA ebmlpa = new Extended_BMLPA("graph.txt",pvalue[j]);
				
			//	Extended_BMLPA ebmlpa = new Extended_BMLPA("modified_new_astro-ph.txt",0.7);
