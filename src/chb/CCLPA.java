...
public class CCLPA {
	...
	public CCLPA(String file,double theta)
	{
		this.theta = theta;
	...
	{
		double thetas[] = {0.0001,0.001,0.003,0.005,0.01,0.03,0.05,0.1,0.2,0.3};	
		String filename[] = {"data2/new_celegansneural.txt","data2/new_windsurfers.txt",
				"data2/modified_new_hep-th.txt","data2/new_dolphins.txt","data2/new_karate.txt",
				"data2/new_lesmis.txt","data2/new_jazz.txt","data2/new_auth.txt","data2/new_football.txt",
				"data2/modified_new_netsience.txt","data2/new_geom.txt",
				"data2/modified_new_cond-mat-1999.txt","data2/modified_new_cond-mat-2003.txt",
				"data2/modified_new_cond-mat-2005.txt","data2/modified_new_astro-ph.txt"};
		...
		for(int j=0;j<filename.length;j++)
		{
			...
			{
				CCLPA owlpa = new CCLPA(filename[j],thetas[i]);
